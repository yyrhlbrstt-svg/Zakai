...
const paths = [
  ...
  { path: "/.well-known/zakai-inbound-receive.json", expect: 200 },
  { path: "/api/institution/inbound-receive", expect: 200 },
  { path: "/.well-known/zakai-agent-economy.json", expect: 200 },
  { path: "/.well-known/zakai-agents.json", expect: 200 },
  { path: "/.well-known/zakai-pipe.json", expect: 200 },
  { path: "/api/pipe", expect: 200 },
  { path: "/api/pipe/mark", expect: 200 },
  { path: "/api/pipe/handoff", expect: 200 },
  { path: "/he/pipe", expect: 200 },
  { path: "/.well-known/zakai-fairness-certified.json", expect: 200 },
  ...
  { path: "/api/network/gravity", expect: 200 },
  { path: "/api/network/monopoly", expect: 200 },
  { path: "/api/network/trillion-gates", expect: 200 },
  { path: "/api/network/indispensability", expect: 200 },
  { path: "/api/institution/ignore-cost", expect: 200 },
  { path: "/api/autopilot/status", expect: 200 },
  { path: "/api/mandate/delegation/issuers", expect: 200 },
  { path: "/api/mandate/delegation/evidence", expect: 200 },
  { path: "/api/network/join-kit", expect: 200 },
  { path: "/api/fairness/certified?market=IL", expect: 200 },
  ...
  { path: "/he/fairness-certified", expect: 200 },
  { path: "/api/regulatory/snapshot?market=IL&format=md", expect: 200 },
  ...
  { path: "/he/must-have", expect: 200 },
  { path: "/he/domains", expect: 200 },

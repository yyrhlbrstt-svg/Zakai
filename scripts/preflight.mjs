...
const CHECKS = [
  ...
  { key: "CRON_SECRET", level: "blocking",
    cost: "In production every cron endpoint refuses to run (503, fail-closed) — daily agent follow-ups, Vigil, evolve and the monthly digest all stop. Set it in Vercel and the platform sends it automatically on each invocation." },

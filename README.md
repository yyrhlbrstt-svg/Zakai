...
1. **Consumer recovery** — problem doors → scan → Case → Ed25519 Mandate → agent send/follow-up → SavingsProof → fee only on documented savings. No call center. No phone left behind.

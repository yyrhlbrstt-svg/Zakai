...
export async function GET() {
  return NextResponse.json({
    ...
    name: "zakai",
    version: "1.0.0",
    buildMarker: "provider-he-cors-saved-doors-homepage-v1-2026-07-28",
    positioning: "standard consumer money agent + Mandate infrastructure",
    tracks: {
      consumer: "problem-first entry · Money OS · agent recovery loop · viral after SAVED · household · electricity full",
      infrastructure: "Ed25519 Mandate standard · JWKS · CORS verify · B2B embed · institutional pilot",
    },

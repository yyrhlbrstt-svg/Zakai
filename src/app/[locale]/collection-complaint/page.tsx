...
import { CollectionComplaintAgent } from "@/components/CollectionComplaintAgent";
    ...
    <VerticalPageShell
      ...
      footer={
        <div className="mt-8 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.02)] p-5 text-center">
          ...
          <p className="text-ink-soft text-body mt-2 mb-4">{t("usSub")}</p>

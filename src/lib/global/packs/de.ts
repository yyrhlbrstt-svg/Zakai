...
const rights: RightDef[] = [
  right(
    "lohnsteuer_jahresausgleich",
    "tax",
    working,
    "EStG — Veranlagung / Lohnsteuerermäßigung",
    {
      kind: "letter",
      recipient: "finanzamt",
  ...
  right(
    "bankentgelte_pruefung",
    "banking",
    always,
    "BGB / AGB-Banken — unwirksame Entgeltklauseln (BGH-Rechtsprechung)",
    {
      kind: "letter",
      recipient: "bank",
  ...
  right(
    "strom_gas_abrechnung",
    "energy",
    always,
    "EnWG / Messstellenbetriebsgesetz — Abrechnungs- und Guthabenansprüche",
    {
      kind: "letter",
      recipient: "provider",
      fields: ["counterparty", "accountNumber"],
  ...
  right(
    "pflege_kranken_beitrag",
    "health",
    any(working, senior, disability),
    "SGB V — Beitrags- und Erstattungsfragen",
    {
      kind: "letter",
  ...
  right(
    ...
    "consumer",
    always,
    "BGB Widerruf / Kündigung von Dauerschuldverhältnissen",
    { kind: "tool", tool: "/scan" },
  ),
];

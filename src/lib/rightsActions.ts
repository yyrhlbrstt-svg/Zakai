...
ככל שנגבו עמלות מעבר למסלול או עמלות כפולות — אבקש לזכות את חשבוני בהתאם. אבקש תשובה בכתב תוך 14 ימים.`,
  ...
  bank_loan_opening_commission_il: {
    ...
    recipient: "bank",
    fields: ["counterparty", "accountNumber", "details"],
    subject: "בקשה לבחינת עמלת פתיחת הלוואה / עמלת טיפול והחזר בגין חיובים לא חוקיים",
    body: `אני, ${IDENTITY}, לקוח/ה מספר {accountNumber}. בקשר להלוואה: {details}.
אבקש פירוט מלא של עמלות הפתיחה, הטיפול וההקמה שנגבו, לרבות בסיס החוקי לכל עמלה, והשוואה לכללי הבנקאות (שירות ללקוח)(עמלות) והוראות המפקח על הבנקים.
ככל שנגבו עמלות שלא הותרו או שלא הוסברו מראש בכתב — אבקש לזכות את חשבוני בהפרש. אבקש תשובה מנומקת בכתב תוך 14 ימים.`,
  },
  bank_senior_track: {
    kind: "letter",
    recipient: "bank",
...
אבקש אישור ניתוק בכתב, וכן החזר של כל סכום שייגבה לאחר מועד הניתוק.`,
  ...
  collection_agency_complaint_il: {
    ...
    recipient: "provider",
    fields: ["counterparty", "details"],
    subject: "תלונה על גביית חוב — הפסקת הטרדה ואימות החוב בכתב",
    body: `אני, ${IDENTITY}, נפנו אליי בנוגע לחוב שמיוחס לי. בהתאם לחוק הגנת הצרכן, התשמ״א-1981, ולהנחיות רשות שוק ההון בנושא גביית חובות, אבקש:
1. לספק בכתב פירוט מלא של החוב, מקורו והבסיס החוקי לגבייתו.
2. להפסיק פניות טלפוניות או הודעות חוזרות שאינן עומדות בכללי ההתנהלות הראויה.
3. ליידע אותי בכתב על כל פעולה עתידית מתוכננת בנוגע לחוב.

פרטים נוספים: {details}`,
  },
  car_insurance_pro_rata_refund: {
    kind: "letter",
    recipient: "insurer",
    fields: ["counterparty", "accountNumber", "details"],
    subject: "ביטול פוליסת ביטוח רכב — החזר פרמיה יחסי",
    body: `אני, ${IDENTITY}, מבוטח/ת מספר {accountNumber} אצלכם. אני מודיע/ה על ביטול פוליסת ביטוח הרכב שלי: {details}.
לפי חוק חוזי הביטוח, התשמ״א-1981, אבקש לסלק את הפוליסה ולהשיב לי את יתרת הפרמיה ששולמה בגין תקופה שלא נוצלה, בתוך המועד הקבוע בחוק.
אבקש אישור בכתב על מועד סיום הכיסוי ועל סכום ההחזר.`,
  },
  vaad_bait_accounting_il: {
    kind: "letter",
    recipient: "provider",
    fields: ["counterparty", "period", "details"],
    subject: "בקשה לפירוט חיובי ועד בית ולדוחות כספיים",
    body: `אני, ${IDENTITY}, דייר/ת בבניין המנוהל על ידי {counterparty}. אבקש לקבל את דוחות הוועד המלאים לתקופה {period}, כולל פירוט הוצאות, חשבוניות ויתרות, בהתאם לחובת הניהול התקין של הוועד.
בנוסף, בקשתי לקבל הסבר בכתב לגבי החיוב הבא: {details}. אין במכתב זה ייעוץ משפטי.`,
  },
  rental_essential_repairs_il: {
    kind: "letter",
    recipient: "provider",
    fields: ["counterparty", "details"],
    subject: "דרישה לתיקון ליקוי מהותי בדירה שכורה",
    body: `אני, ${IDENTITY}, שוכר/ת דירה בבעלותכם. מצאתי ליקוי מהותי הדורש תיקון: {details}.
אבקש לתאם תיקון תוך זמן סביר, בהתאם לחובות המשכיר לפי חוק השכירות והשאילה. אבקש אישור בכתב על מועד התיקון. אין במכתב זה ייעוץ משפטי.`,
  },
  consumer_warranty_il: {
    kind: "letter",
    recipient: "provider",
    fields: ["counterparty", "details"],
    subject: "מימוש אחריות יצרן/יבואן — תיקון או החלפה",
    body: `אני, ${IDENTITY}, רכשתי מוצר אצלכם/מיוצרכם. המוצר בתוך תקופת האחריות ונמצא בליקוי: {details}.
אבקש לממש את האחריות ולתקן את המוצר ללא תשלום, או להחליפו/להשיב את התמורה בהתאם לדין החל. אבקש תשובה בכתב תוך זמן סביר. אין במכתב זה ייעוץ משפטי.`,
  },

    ...
    <div className="mt-8">
      ...
      <Card className="p-6 flex flex-col gap-4">
        ...
        <div className="grid gap-3.5 [grid-template-columns:repeat(auto-fit,minmax(180px,1fr))]">
          ...
          <label className="block">
            <span className="text-body text-ink-soft block mb-1.5">{t("agent.invoiceNumber")}</span>
          ...
          <label className="block">
            <span className="text-body text-ink-soft block mb-1.5">{t("agent.amount")}</span>
            <Input type="number" value={amount} onChange={(e) => setAmount(e.target.value)} />
          </label>
        </div>
        <label className="block">
          <span className="text-body text-ink-soft block mb-1.5">{t("agent.details")}</span>

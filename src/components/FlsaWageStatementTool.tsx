  ...
  return (
    <div className="mt-8">
      ...
      <Card className="p-6 flex flex-col gap-4">
        ...
        <label className="block">
          <span className="text-body text-ink-soft block mb-1.5">{t("periodQ")}</span>
        ...
        <MissingFields
          items={[
            { ok: employerName.trim().length > 0, label: t("employerQ") },
            { ok: payPeriod.trim().length > 0, label: t("periodQ") },
          ]}
        />
